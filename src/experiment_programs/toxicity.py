...
def main():
    ...
    df1.to_csv('results/toxicity_evolutionary_forest.csv', index=False)
    df2.to_csv('results/toxicity_sklearn_forest.csv', index=False)
