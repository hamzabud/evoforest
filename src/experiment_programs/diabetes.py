...
def main():
    ...
    data = prepare_data(train, 'Diabetes_binary')
    ...
    params = EvoParams(
        ...
        training_sample_size = data['X_train'].shape[0] // 10,
    ...
    df1.to_csv('results/Diabetes_binary_evolutionary_forest.csv', index=False)
    df2.to_csv('results/Diabetes_binary_sklearn_forest.csv', index=False)
